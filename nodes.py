...
from .node_defs.spaceship_character import (
    NODE_CLASS_MAPPINGS as SPACESHIP_CHAR_CLASS_MAPPINGS,
)
from .node_defs.spaceship_character import (
    NODE_DISPLAY_NAME_MAPPINGS as SPACESHIP_CHAR_DISPLAY_NAME_MAPPINGS,
)
from .node_defs.spaceship_mods import (
    NODE_CLASS_MAPPINGS as SPACESHIP_MODS_CLASS_MAPPINGS,
)
from .node_defs.spaceship_mods import (
    NODE_DISPLAY_NAME_MAPPINGS as SPACESHIP_MODS_DISPLAY_NAME_MAPPINGS,
)
...
NODE_CLASS_MAPPINGS = {
    ...
    **SPACESHIP_CHAR_CLASS_MAPPINGS,
    **SPACESHIP_MODS_CLASS_MAPPINGS,
}
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **SPACESHIP_CHAR_DISPLAY_NAME_MAPPINGS,
    **SPACESHIP_MODS_DISPLAY_NAME_MAPPINGS,
}
