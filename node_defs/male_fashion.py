    ...
    def INPUT_TYPES(s):
        ...
        return {
            ...
            "optional": {
                ...
                "mens_belt": combo("mens_belt_list"),
                "mens_belt_color": combo("mens_belt_color_list"),
                "mens_belt_material": combo("mens_belt_material_list"),
                "necklace": combo("mens_necklace_list"),
                "bracelet": combo("mens_bracelet_list"),
                "watches": combo("mens_watches_list"),
                "watches_color": combo("watches_color_list"),
                "ring": combo("mens_ring_list"),
